...
int main(){
    static uint16_t eeMLX90640[832]; //See MLX90640 driver.pdf page 9
    float emissivity = 1; //lookup depends on what you're trying to id, 1 is perfect (nothing is this way), but the value gives usable results
    uint16_t frame[834]; //See MLX90640 driver.pdf page page 11
    static float image[768];
    static float mlx90640To[768];
    float eTa; //ambient temp in C
    ...
    while (1){
        ...
        eTa = MLX90640_GetTa(frame, &mlx90640); //getambient temperature of sensor
